...
func newDevice(doer Doer, serverURL string) (*device, error) {
	const topic = "com.example.apns.topic"

	e, err := enrollment.NewRandomDeviceEnrollment(doer, topic, serverURL, "")
	if err != nil {
		return nil, err
	}
